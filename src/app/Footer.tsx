      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 gap-x-12 gap-y-16 md:col-span-3 lg:grid-cols-6">
          <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
            <div className="text-2xl font-bold">Nextstixch</div>
          ...
          <div className="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
            ...
            <form action="#" method="POST" className="mt-6">
              ...
              <Button
                type="submit"
                size="lg"
                className="bg-primary mt-3 inline-flex items-center justify-center rounded-md px-6 py-4"
              >
                Subscribe
              </Button>
            </form>
        ...
        <p className="text-muted-foreground text-center text-sm">
          © Copyright {new Date().getFullYear()}, All Rights Reserved by Nextstixch
        </p>
      </div>
    </footer>
  );
